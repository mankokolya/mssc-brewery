package guru.springframework.msscbrewery.web.cnotroller.v2;
...
public class BeerControllerV2 {
    ...
    @GetMapping("/{beerId}")
    public ResponseEntity<BeerDtoV2> getBear(@PathVariable("beerId")UUID beerId) {
    ...
    public ResponseEntity handlePost(@RequestBody BeerDtoV2 beerDtoV2) {
        ...
        headers.add("Location", "api/v2/beer/" + savedBeerDtoV2.getId().toString());
